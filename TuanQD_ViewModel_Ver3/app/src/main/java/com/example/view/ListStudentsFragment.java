...
public class ListStudentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListStudentViewModel listStudentViewModel = new ViewModelProvider(requireActivity(),
                new ListViewModelFactory(requireContext())).get(ListStudentViewModel.class);

        studentList = new ArrayList<>();
        studentList= listStudentViewModel.getStudents().getValue();
        Log.i("LIST",""+studentList.size());
